...
public class DocumentSpy implements Document {
	...
	public List<String> createdTagNames = new ArrayList<>();
	public List<ElementSpy> createdElements = new ArrayList<>();
	public List<Node> appendedChildren = new ArrayList<>();
	public List<String> createdTextNodes = new ArrayList<>();
	...
	public Element createElement(String tagName) throws DOMException {
		...
		ElementSpy elementSpy = new ElementSpy();
		createdElements.add(elementSpy);
		return elementSpy;
	}
