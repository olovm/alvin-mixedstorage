...
public class TestDataProvider {
	...
	public static String place22_historicCountry_XML = "<place id=\"1\">\n"
			+ "  <pid>alvin-place:22_historic</pid>\n" + "  <dsId>METADATA</dsId>\n"
			+ "  <recordInfo id=\"2\">\n" + "    <externalDs>false</externalDs>\n"
			+ "    <lastAction>UPDATED</lastAction>\n" + "    <created id=\"3\">\n"
			+ "      <date id=\"4\">2014-12-18 20:20:38.346 UTC</date>\n"
			+ "      <dateInStorage id=\"5\">2014-12-18 20:20:39.815 UTC</dateInStorage>\n"
			...
			+ "        <note>Place updated through web gui</note>\n"
			+ "        <type>UPDATED</type>\n" + "      </userAction>\n" + "    </updated>\n"
			+ "  </recordInfo>\n" + "  <country class=\"historicCountry\" id=\"11\">\n"
			+ "    <lastUpdated class=\"sql-timestamp\" id=\"12\">2016-03-03 16:44:01.478667</lastUpdated>\n"
			+ "    <defaultName>Gallien</defaultName>\n" + "    <localisedNames id=\"13\">\n"
			+ "      <entry>\n" + "        <string>en</string>\n"
			+ "        <string>Gaul</string>\n" + "      </entry>\n" + "    </localisedNames>\n"
			+ "    <code>gaul</code>\n" + "  </country>\n" + "  <regions id=\"16\"/>\n"
			+ "  <defaultPlaceName id=\"17\">\n" + "    <deleted>false</deleted>\n"
	...
	public static String place22_historicCountryNonCamelCased_XML = "<place id=\"1\">\n"
			+ "  <pid>alvin-place:22_historic</pid>\n" + "  <dsId>METADATA</dsId>\n"
			+ "  <recordInfo id=\"2\">\n" + "    <externalDs>false</externalDs>\n"
			+ "    <lastAction>UPDATED</lastAction>\n" + "    <created id=\"3\">\n"
			+ "      <date id=\"4\">2014-12-18 20:20:38.346 UTC</date>\n"
			...
			+ "      <entry>\n" + "        <string>en</string>\n"
			+ "        <string>Gaul</string>\n" + "      </entry>\n" + "    </localisedNames>\n"
			+ "    <code>duchy_of_saxe_coburg_meiningen</code>\n" + "  </country>\n"
			+ "  <regions id=\"16\"/>\n" + "  <defaultPlaceName id=\"17\">\n"
			+ "    <deleted>false</deleted>\n" + "    <name>CoburgCoburgMeiningenMeiningen</name>\n"
			+ "  </defaultPlaceName>\n" + "  <placeNameForms id=\"18\"/>\n" + "  <identifiers/>\n"
			+ "  <localIdentifiers id=\"19\">\n" + "    <localIdentifier>\n"
			+ "      <type class=\"localIdentifierType\">\n"
			+ "        <lastUpdated class=\"sql-timestamp\">2014-04-17 08:49:50.65</lastUpdated>\n"
	...
	public static String place22_historicCountryNonNormalized_XML = "<place id=\"1\">\n"
			+ "  <pid>alvin-place:22_historic</pid>\n" + "  <dsId>METADATA</dsId>\n"
			+ "  <recordInfo id=\"2\">\n" + "    <externalDs>false</externalDs>\n"
			+ "    <lastAction>UPDATED</lastAction>\n" + "    <created id=\"3\">\n"
			+ "      <date id=\"4\">2014-12-18 20:20:38.346 UTC</date>\n"
			...
			+ "    <defaultName>Gallien</defaultName>\n" + "    <localisedNames id=\"13\">\n"
			+ "      <entry>\n" + "        <string>en</string>\n"
			+ "        <string>Herradöme Trčka von Lípa</string>\n" + "      </entry>\n"
			+ "    </localisedNames>\n" + "    <code>lordship_trcka_lipa</code>\n"
			+ "  </country>\n" + "  <regions id=\"16\"/>\n" + "  <defaultPlaceName id=\"17\">\n"
			+ "    <deleted>false</deleted>\n" + "    <name>CoburgCoburgMeiningenMeiningen</name>\n"
			+ "  </defaultPlaceName>\n" + "  <placeNameForms id=\"18\"/>\n" + "  <identifiers/>\n"
			+ "  <localIdentifiers>\n" + "  </localIdentifiers>\n"
	...
	public static String place22_historicCountryNonCamelCasedAndNonNormalized_XML = "<place id=\"1\">\n"
			+ "  <pid>alvin-place:22_historic</pid>\n" + "  <dsId>METADATA</dsId>\n"
			+ "  <recordInfo id=\"2\">\n" + "    <externalDs>false</externalDs>\n"
			+ "    <lastAction>UPDATED</lastAction>\n" + "    <created id=\"3\">\n"
			+ "      <date id=\"4\">2014-12-18 20:20:38.346 UTC</date>\n"
			...
			+ "    <defaultName>Gallien</defaultName>\n" + "    <localisedNames id=\"13\">\n"
			+ "      <entry>\n" + "        <string>en</string>\n"
			+ "        <string>Herradöme Trčka_von-Lípa</string>\n" + "      </entry>\n"
			+ "    </localisedNames>\n" + "    <code>lordship_trcka_lipa</code>\n"
			+ "  </country>\n" + "  <regions id=\"16\"/>\n" + "  <defaultPlaceName id=\"17\">\n"
			+ "    <deleted>false</deleted>\n" + "    <name>CoburgCoburgMeiningenMeiningen</name>\n"
			+ "  </defaultPlaceName>\n" + "  <placeNameForms id=\"18\"/>\n" + "  <identifiers/>\n"
